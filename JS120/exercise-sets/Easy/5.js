...
// should be a single space and the words Meow meow!. For example:
...
let cat = new Cat("Pepe", 2, "happy");
console.log(cat.introduce() === "Hello, my name is Pepe and I am 2 years old " +
                                "and happy. Meow meow!");
// logs true

let dog = new Dog('Hubie', 2, 'happy', 'Anne');
console.log(dog.introduce() === 'Hello, my name is Hubie and I am 2 years old ' +
                                'and happy.');
// logs true
console.log(dog.greetMaster() === 'Hello Anne! Woof, woof!');
// logs true
