...
//  The 2 disadvantages of working with factory functions are:
//  - Every object created with a fctory function has a full copy of all the
//    methods. That's redundant and can place a heavy load on system memory.
//  - There is no way to inspect an object and learn whether we created it with
//    a factory function. That effectively makes it impossible to identify the
//    specific 'type' of the object; at best, you can only determine that an
//    object has some specific characteristics


// 2. Rewrite the following code to use object-literal syntax to generate the
//    returned object:
...
// 3. In this problem and the remaining problems, we'll build a simple invoice
//    processing program. To get you started, here's the code to process a
//    single invoice:
...
// 4. Now we can build a factory function to create payments. The function can
...
// 5. Update the createInvoice function so that it can add payment(s) to
