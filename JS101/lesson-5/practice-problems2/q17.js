...
some of those items were created on a different server or by a different
...
stepping on each other's toes. It accomplishes this feat through massive
randomization. The number of possible UUID values is approximately 3.4 X 10E38,
which is a huge number. The chance of a conflict is vanishingly small with such
...
function createUUID () {
  ...
  sections.forEach((section, sectionIndex) => {
    for (let index = 1; index < section; index += 1) {
