...
// The issue here is that the sort() method in the median() function was used
// without arguments. When used without arguments, it sorts the array
// alphanumerically, by converting it to a string first. In order to correct
// this we need to change the sort callback to account for the values of the
// array being all numbers, and sorting them based on the total number values.
