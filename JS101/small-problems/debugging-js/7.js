...
// The issue here is that there is no break in the switch statement, so it falls
// through to each of the next cases. To correct this we would need to add break
